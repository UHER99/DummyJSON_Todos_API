...
const ViewUserTodos = () => {
    ...
    const { completedTodos, notCompletedTodos, data } = useListTodos(id);
    ...
    return (
        <div>
            ...
            <div className="flex gap-4">
                {/* Profile Panel */}
                <div className="min-h-screen w-[210px] bg-slate-200 rounded-[10px]">
                ...
                <div className="w-full mt-6">
                    ...
                    <div className="mt-6">
                        <div>
                            <p className="text-[18px]">My list Todos</p>
